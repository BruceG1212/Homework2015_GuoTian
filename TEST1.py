...
end_p = ginput(1)
xval, yval = end_p[0]
X_val1 = int(xval / 206 * 14) + 1
Y_val1 = int(yval / 180 * 12) + 1
print(X_val1,Y_val1)
...
#########set starting point#
easygui.msgbox("Please select initial point: ")
start_p = ginput(1)
xval, yval = start_p[0]
X_val2 = int(xval / 206 * 14) + 1
Y_val2 = int(yval / 180 * 12) + 1
print(X_val2,Y_val2)
...
######set obstacles#########
easygui.msgbox("Please select 5 obstacles position: ")
ob = ginput(5)
